###############################################
##
## Script name: 3_Pebble_Count_Data.R
##
...
#Real (whole) Data
#Note Round was blank for one size class at the Dog eFishing reach in the original WSP file. This was corrected on 3/31/21

pc.dat <- read.csv("Data/Scott_Creek_Pebble_20210331.csv", sep = ",", header = T) #736 obs of 7 var. 
