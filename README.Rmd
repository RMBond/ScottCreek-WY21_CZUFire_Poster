...
```{r Big Creek and the Lower mainstem quick cumulative percent finer plots}
...
```{r Percent surface fines along the mainstem by station number }
...
```{r Boxplot of percent surface fines}
